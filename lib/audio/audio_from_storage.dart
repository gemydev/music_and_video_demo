...
class AudioFromLocalStorage extends StatefulWidget {

  final File file;

  AudioFromLocalStorage({this.file});
  
  @override
  _AudioFromLocalStorageState createState() => _AudioFromLocalStorageState();
}

class _AudioFromLocalStorageState extends State<AudioFromLocalStorage> {
